...
class PathFusionLoss(torch.nn.Module):
    def __init__(self):
        super(PathFusionLoss,self).__init__()

    def forward(self,feature1,feature2,gt):
        fusion=feature1*feature2
        return torch.nn.MSELoss()(fusion,gt)

class PathFusionLossPlus(torch.nn.Module):
    def __init__(self,subscale=0.1):
        self.subscale=int(1/subscale)
        super(PathFusionLossPlus,self).__init__()

    def forward(self,feature1,feature2,gt):
        mseloss=PathFusionLoss()(feature1,feature2,gt)
