...
trainset=PCDataset3D('/newdata/why/MVI_Liver_Formatted/',mode='train',augment=False)
testset=PCDataset3D('/newdata/why/MVI_Liver_Formatted/',mode='test') 
...
# model.load_state_dict(pt.load(model_path+'/PointUnet/PointUNet_3D_Liver_patch-free_bs1_best_0.8153.pt',map_location = 'cpu'))
...
for x in range(epoch):
    ...
    if dice>best_dice:
        best_dice=dice
        print('New best dice! Model saved to',model_path+'/PointUnet/PointUNet_3D_Liver_patch-free_bs'+str(batch_size)+'_best.pt')
        pt.save(model.state_dict(), model_path+'/PointUnet/PointUNet_3D_Liver_patch-free_bs'+str(batch_size)+'_best.pt')
    # print('===TEST===>')
    # TestModel() 
