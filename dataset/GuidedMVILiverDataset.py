...
class GuidedMVILiverDataset3D(torch.utils.data.Dataset):
    def __init__(self,path,mode='train',cropping_method='selective',augment=True):
        ...
        if mode=='train':
            ...
            for i in range(len(images)):
                ...
                image=self.reset_spacing(image,sitk.sitkBSplineResamplerOrder3)
...
if __name__=='__main__':
    dataset=GuidedMVILiverDataset3D('/newdata/why/MVI_Liver_Formatted',train=True)
